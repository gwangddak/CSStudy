...
namespace Ch03
{
    internal class _5_배열
    {
        ...
        {
            //배열
            int[] arr1 = new int[3];  //null
            arr1[0] = 1;
            arr1[1] = 2;
            arr1[2] = 3;

            int[] arr2 = { 0, 1, 2, 3, 4, 5 }; // 직관적 // Length 5
            ...
            //배열 길이
            Console.WriteLine("arr1의 배열길이 : " + arr1.Length);
            Console.WriteLine("arr2의 배열길이 : " + arr2.Length);
            Console.WriteLine("arr3의 배열길이 : " + arr3.Length);
            ...
            Console.WriteLine("arr3d : [1,0,1] : " + arr3d[1,2,1]);
            Console.WriteLine("arr3d : [1,0,1] : " + arr3d[2,2,0]);
